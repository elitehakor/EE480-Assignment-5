...
module instruction_block(clk, reset, jump_taken, jump_addr, pc_buff, ir, parallel_store_en, parallel_addr_reg, parallel_val_reg );
...
module processor(clk, reset, jump, halt, pc, ir, u0, u1, u2, u3, u4, u5, u6, u7, u8, u9, parallel_store_mon, parallel_addr_mon, parallel_val_mon );
input clk, reset;
output reg jump;
output halt;
...
instruction_block ib(clk, reset, jump_taken, jump_addr, pc_buff, ir_conn, parallel_store_en__inst_to_reg, parallel_addr_reg__inst_to_reg, parallel_val_reg__inst_to_reg );
